...
version: 
Author: 
Date: 2021-08-11 03:03:48
LastEditors: Please set LastEditors
LastEditTime: 2021-08-11 03:03:49
'''
'''
Descripttion: 
version: 
Author: 
Date: 2021-05-19 10:37:28
LastEditors: Please set LastEditors
LastEditTime: 2021-05-19 10:40:38
'''
'''
Descripttion: 
version: 
Author: 
Date: 2021-05-18 02:29:54
LastEditors: Please set LastEditors
LastEditTime: 2021-05-19 10:36:43
'''
'''
...
LastEditors: Please set LastEditors
LastEditTime: 2021-05-18 01:53:44
'''
...
MODEL_PATH = '/mnt/sda1/cj/Keras_Knowledge_Distillation/checkpoints/train_model_TEMPERATURE_25_Teacher_train_model_v6/epoch_021_acc_0.891342_loss_0.044123/keras_watch_screen_model_epoch_20.h5'
...
TEST_LIST = '/mnt/sda1/cj/Keras_Knowledge_Distillation/test_data/test_nopeople_list.txt'
SAVE_ROOT = '/mnt/sda1/cj/Keras_Knowledge_Distillation/inference'
...
def detect(model,full_image_path, screen_bboxes, head_bboxes, draw=True, save_root=None):
    ...
    screen = fullimage_[sc_ymin:sc_ymax, sc_xmin:]
    ...
    if draw:
        ...
        new_name = full_image_path.split('/')[-1][:-4]+"_result.jpg"
